...
//		//4. details of student
		...
		et.begin();
		em.remove(card); // this will throw a foreign key constrains Persistence exception if we want to
							// remove this first we need to nullify in student then connection removes and
							// then it will done
		et.commit();
